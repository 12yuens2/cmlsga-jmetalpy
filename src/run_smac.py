...
if __name__ == "__main__":
    ...
    output_path = "/ssdfs/users/sy6u19/smac-heia-300k"
    ...
    with open(sys.argv[1], "r") as smac_file:
        ...
        for line in reader:
            ...
            if line[0] == "moeade":
                ...
                F = float(line[7])
                neighbour_size = int(line[8])
                neighbour_select = float(line[9])
                ...
                moead = True
                neighbour_size = int(line[5])
                neighbour_select = float(line[6])
                F = float(line[7])
            ...
            #if moead == True: 
            #    constructor, kwargs = algorithm(problem, population_size, max_evaluations, e, mutation_rate, crossover_rate, F, neighbour_size, neighbour_select)
            #else:
            ...
            for run in range(runs):
                ...
                jobs.append(Job(algorithm, algorithm.get_name(), 
