...
class WFG(FloatProblem):
    ...
    def __init__(self,
        ...
        self.lower_bound = self.min_bounds
        self.upper_bound = self.max_bounds
...
class WFG8(WFG):
    ...
    def __init__(self, num_objectives=2, num_variables=6, k=2):
        super(WFG8, self).__init__(self.objective_function,
                                num_objectives,
                                num_variables,
                                k)
        self.shape = WFG4.WFG4Shape()
...
class WFG9(WFG):
    ...
    def __init__(self, num_objectives=2, num_variables=6, k=2):
        super(WFG9, self).__init__(self.objective_function,
                                num_objectives,
                                num_variables,
                                k)
        self.shape = WFG4.WFG4Shape()
